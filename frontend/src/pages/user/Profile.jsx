          ...
          <div className="px-6 pb-6 pt-0">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-6">
              ...
              <div className="relative">
                <div className="w-32 h-32 rounded-full bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center overflow-hidden shadow-lg">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mt-2 flex-wrap">
                  <span
                    className={`px-3 py-1 rounded-full text-sm font-medium ${getUserBadgeColor()}`}
                  >
                    {profile.userType}
                  </span>
